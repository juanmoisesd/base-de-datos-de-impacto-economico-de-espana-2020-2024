# analysis.py — Base de Datos de Impacto Económico de España (2020-2024)
...
keywords = ['España', 'macroeconomía', 'PIB', 'inflación', 'turismo']
...
print(f"Dataset: Base de Datos de Impacto Económico de España (2020")
print(f"DOI: 10.5281/zenodo.18879794")
...
fig.suptitle("Base de Datos de Impacto Económico de España (2020-2024)", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Base de Datos de Impacto Económico de España (2020-2024). Zenodo. https://doi.org/10.5281/zenodo.18879794
""")
